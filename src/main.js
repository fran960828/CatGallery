...
const key={'x-api-key':'live_S1P0w7XlhXs5AQeZ1ST2rLbWjtvNeHBX8rGaL7pqmZdNxbXGlxKyxk7XQEUYsxgH'};
  ...
  renderCats(cats) {
    cats.forEach(cat => {
      ...
      card.querySelector('.fav-btn').addEventListener('click', (event) => {
        ...
        this.favoritesStorage.isFavorite(cat.id) ? btn.textContent='❤️' : btn.textContent='🤍'
      });
